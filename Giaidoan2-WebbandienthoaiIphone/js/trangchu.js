window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		var soLuong = (window.innerWidth < 1200 ? 3 : 9); // màn hình nhỏ thì hiển thị ít hơn
		...
		addKhungSanPham('IPHONE CHÍNH HÃNG', green, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
...
var soLuongSanPhamMaxTrongMotTrang = 18;
