	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="lienhe.html"><i class="fa fa-info-circle"></i> Liên hệ</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
	...
	<div class="header group">
        ...
        <div class="content">
            <div class="search-header"  left: 50px; top: 1px;">
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html"></a>Địa chỉ: 459 Tôn Đức Thắng, phường Hòa Khánh Nam, quận Liên Chiểu, thành phố Đà Nẵng - Hotline: 0522790125, Email: 7memberstore@gmail.com - Thiết kế by
            <span style="color: #eee; font-weight: bold">7Member Teams</span></p>
    </div>`);
}
